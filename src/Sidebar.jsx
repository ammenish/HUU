...
const Sidebar = ({ user, active, setActive, logout }) => {
    const nav = {
        admin: [{ k: "dashboard", l: "Dashboard", i: "dash" }, { k: "users", l: "User Management", i: "users" }, { k: "templates", l: "Gist Templates", i: "tpl" }, { k: "sectors", l: "Sector Params", i: "cog" }, { k: "allApps", l: "All Applications", i: "file" }],
